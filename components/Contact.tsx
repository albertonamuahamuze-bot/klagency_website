        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-white/55 text-lg leading-relaxed mb-10 max-w-md">
              Entre em contacto e vamos começar uma conversa estratégica sobre o posicionamento da sua marca.
            </p>
            ...
            {contactItems.map((c, i) => (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "0 8px 32px rgba(0,27,143,0.18), inset 0 1px 0 rgba(255,255,255,0.07)",
                }}
              >
                ...
                <div className="space-y-2">
                  {c.items.map((item) => (
                    ...
                    >
                      ...
                      <ExternalLink
                        size={12}
                        className="text-white/25 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                      />
                    </a>
                  ))}
                </div>
