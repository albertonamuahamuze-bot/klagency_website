...
export default function Differentials() {
  return (
    <section className="relative py-28 lg:py-36 overflow-hidden" style={{ background: "#020B1A" }}>
      ...
      />
      {/* Glow left */}
      <div className="absolute top-1/2 -left-32 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-[#2563EB]/7 blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 text-white font-semibold px-7 py-3.5 rounded-xl transition-all duration-200 hover:-translate-y-px text-sm"
              style={{
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-[#06B6D4] text-xs font-bold">{d.number}</span>
